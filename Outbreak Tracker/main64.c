...
char GetFile()
{
    ...
    if (f1_7FF61 == 0x4D504C53){BasePointer=+0x7FF610000000;return 1;}
    if (f2_7FF61 == 0x4D504C53){BasePointer=+0x7FF610000000;return 2;}
    if (f1_7FF62 == 0x4D504C53){BasePointer=+0x7FF620000000;return 1;}
    if (f2_7FF62 == 0x4D504C53){BasePointer=+0x7FF620000000;return 2;}
    if (f1_7FF63 == 0x4D504C53){BasePointer=+0x7FF630000000;return 1;}
    if (f2_7FF63 == 0x4D504C53){BasePointer=+0x7FF630000000;return 2;}
    if (f1_7FF64 == 0x4D504C53){BasePointer=+0x7FF640000000;return 1;}
    if (f2_7FF64 == 0x4D504C53){BasePointer=+0x7FF640000000;return 2;}
    if (f1_7FF65 == 0x4D504C53){BasePointer=+0x7FF650000000;return 1;}
    if (f2_7FF65 == 0x4D504C53){BasePointer=+0x7FF650000000;return 2;}
    if (f1_7FF66 == 0x4D504C53){BasePointer=+0x7FF660000000;return 1;}
    if (f2_7FF66 == 0x4D504C53){BasePointer=+0x7FF660000000;return 2;}
    if (f1_7FF67 == 0x4D504C53){BasePointer=+0x7FF670000000;return 1;}
    if (f2_7FF67 == 0x4D504C53){BasePointer=+0x7FF670000000;return 2;}
    if (f1_7FF68 == 0x4D504C53){BasePointer=+0x7FF680000000;return 1;}
    if (f2_7FF68 == 0x4D504C53){BasePointer=+0x7FF680000000;return 2;}
    if (f1_7FF69 == 0x4D504C53){BasePointer=+0x7FF690000000;return 1;}
    if (f2_7FF69 == 0x4D504C53){BasePointer=+0x7FF690000000;return 2;}
    if (f1_7FF6A == 0x4D504C53){BasePointer=+0x7FF6A0000000;return 1;}
    if (f2_7FF6A == 0x4D504C53){BasePointer=+0x7FF6A0000000;return 2;}
    if (f1_7FF6B == 0x4D504C53){BasePointer=+0x7FF6B0000000;return 1;}
    if (f2_7FF6B == 0x4D504C53){BasePointer=+0x7FF6B0000000;return 2;}
    if (f1_7FF6C == 0x4D504C53){BasePointer=+0x7FF6C0000000;return 1;}
    if (f2_7FF6C == 0x4D504C53){BasePointer=+0x7FF6C0000000;return 2;}
    if (f1_7FF6D == 0x4D504C53){BasePointer=+0x7FF6D0000000;return 1;}
    if (f2_7FF6D == 0x4D504C53){BasePointer=+0x7FF6D0000000;return 2;}
    if (f1_7FF6E == 0x4D504C53){BasePointer=+0x7FF6E0000000;return 1;}
    if (f2_7FF6E == 0x4D504C53){BasePointer=+0x7FF6E0000000;return 2;}
    if (f1_7FF6F == 0x4D504C53){BasePointer=+0x7FF6F0000000;return 1;}
    if (f2_7FF6F == 0x4D504C53){BasePointer=+0x7FF6F0000000;return 2;}
    if (f1_7FF70 == 0x4D504C53){BasePointer=+0x7FF700000000;return 1;}
    if (f2_7FF70 == 0x4D504C53){BasePointer=+0x7FF700000000;return 2;}
    if (f1_7FF71 == 0x4D504C53){BasePointer=+0x7FF710000000;return 1;}
    if (f2_7FF71 == 0x4D504C53){BasePointer=+0x7FF710000000;return 2;}
    if (f1_7FF72 == 0x4D504C53){BasePointer=+0x7FF720000000;return 1;}
    if (f2_7FF72 == 0x4D504C53){BasePointer=+0x7FF720000000;return 2;}
    if (f1_7FF73 == 0x4D504C53){BasePointer=+0x7FF730000000;return 1;}
    if (f2_7FF73 == 0x4D504C53){BasePointer=+0x7FF730000000;return 2;}
    if (f1_7FF74 == 0x4D504C53){BasePointer=+0x7FF740000000;return 1;}
    if (f2_7FF74 == 0x4D504C53){BasePointer=+0x7FF740000000;return 2;}
    if (f1_7FF75 == 0x4D504C53){BasePointer=+0x7FF750000000;return 1;}
    if (f2_7FF75 == 0x4D504C53){BasePointer=+0x7FF750000000;return 2;}
    if (f1_7FF76 == 0x4D504C53){BasePointer=+0x7FF760000000;return 1;}
    if (f2_7FF76 == 0x4D504C53){BasePointer=+0x7FF760000000;return 2;}
    if (f1_7FF77 == 0x4D504C53){BasePointer=+0x7FF770000000;return 1;}
    if (f2_7FF77 == 0x4D504C53){BasePointer=+0x7FF770000000;return 2;}
    if (f1_7FF78 == 0x4D504C53){BasePointer=+0x7FF780000000;return 1;}
    if (f2_7FF78 == 0x4D504C53){BasePointer=+0x7FF780000000;return 2;}
    if (f1_7FF79 == 0x4D504C53){BasePointer=+0x7FF790000000;return 1;}
    if (f2_7FF79 == 0x4D504C53){BasePointer=+0x7FF790000000;return 2;}
    if (f1_7FF7A == 0x4D504C53){BasePointer=+0x7FF7A0000000;return 1;}
    if (f2_7FF7A == 0x4D504C53){BasePointer=+0x7FF7A0000000;return 2;}
    if (f1_7FF7B == 0x4D504C53){BasePointer=+0x7FF7B0000000;return 1;}
    if (f2_7FF7B == 0x4D504C53){BasePointer=+0x7FF7B0000000;return 2;}
    if (f1_7FF7C == 0x4D504C53){BasePointer=+0x7FF7C0000000;return 1;}
    if (f2_7FF7C == 0x4D504C53){BasePointer=+0x7FF7C0000000;return 2;}
    if (f1_7FF7D == 0x4D504C53){BasePointer=+0x7FF7D0000000;return 1;}
    if (f2_7FF7D == 0x4D504C53){BasePointer=+0x7FF7D0000000;return 2;}
    if (f1_7FF7E == 0x4D504C53){BasePointer=+0x7FF7E0000000;return 1;}
    if (f2_7FF7E == 0x4D504C53){BasePointer=+0x7FF7E0000000;return 2;}
    if (f1_7FF7F == 0x4D504C53){BasePointer=+0x7FF7F0000000;return 1;}
    if (f2_7FF7F == 0x4D504C53){BasePointer=+0x7FF7F0000000;return 2;}
    if (f1_7FF80 == 0x4D504C53){BasePointer=+0x7FF800000000;return 1;}
    if (f2_7FF80 == 0x4D504C53){BasePointer=+0x7FF800000000;return 2;}
    if (f1_7FF81 == 0x4D504C53){BasePointer=+0x7FF810000000;return 1;}
    if (f2_7FF81 == 0x4D504C53){BasePointer=+0x7FF810000000;return 2;}
    if (f1_7FF82 == 0x4D504C53){BasePointer=+0x7FF820000000;return 1;}
    if (f2_7FF82 == 0x4D504C53){BasePointer=+0x7FF820000000;return 2;}
    if (f1_7FF83 == 0x4D504C53){BasePointer=+0x7FF830000000;return 1;}
    if (f2_7FF83 == 0x4D504C53){BasePointer=+0x7FF830000000;return 2;}
    if (f1_7FF84 == 0x4D504C53){BasePointer=+0x7FF840000000;return 1;}
    if (f2_7FF84 == 0x4D504C53){BasePointer=+0x7FF840000000;return 2;}
    if (f1_7FF85 == 0x4D504C53){BasePointer=+0x7FF850000000;return 1;}
    if (f2_7FF85 == 0x4D504C53){BasePointer=+0x7FF850000000;return 2;}
    if (f1_7FF86 == 0x4D504C53){BasePointer=+0x7FF860000000;return 1;}
    if (f2_7FF86 == 0x4D504C53){BasePointer=+0x7FF860000000;return 2;}
    if (f1_7FF87 == 0x4D504C53){BasePointer=+0x7FF870000000;return 1;}
    if (f2_7FF87 == 0x4D504C53){BasePointer=+0x7FF870000000;return 2;}
    if (f1_7FF88 == 0x4D504C53){BasePointer=+0x7FF880000000;return 1;}
    if (f2_7FF88 == 0x4D504C53){BasePointer=+0x7FF880000000;return 2;}
    if (f1_7FF89 == 0x4D504C53){BasePointer=+0x7FF890000000;return 1;}
    if (f2_7FF89 == 0x4D504C53){BasePointer=+0x7FF890000000;return 2;}
    if (f1_7FF8A == 0x4D504C53){BasePointer=+0x7FF8A0000000;return 1;}
    if (f2_7FF8A == 0x4D504C53){BasePointer=+0x7FF8A0000000;return 2;}
    if (f1_7FF8B == 0x4D504C53){BasePointer=+0x7FF8B0000000;return 1;}
    if (f2_7FF8B == 0x4D504C53){BasePointer=+0x7FF8B0000000;return 2;}
    if (f1_7FF8C == 0x4D504C53){BasePointer=+0x7FF8C0000000;return 1;}
    if (f2_7FF8C == 0x4D504C53){BasePointer=+0x7FF8C0000000;return 2;}
    if (f1_7FF8D == 0x4D504C53){BasePointer=+0x7FF8D0000000;return 1;}
    if (f2_7FF8D == 0x4D504C53){BasePointer=+0x7FF8D0000000;return 2;}
    if (f1_7FF8E == 0x4D504C53){BasePointer=+0x7FF8E0000000;return 1;}
    if (f2_7FF8E == 0x4D504C53){BasePointer=+0x7FF8E0000000;return 2;}
    if (f1_7FF8F == 0x4D504C53){BasePointer=+0x7FF8F0000000;return 1;}
    if (f2_7FF8F == 0x4D504C53){BasePointer=+0x7FF8F0000000;return 2;}
	else return -1;
...
21DEF5044D0
1D49A410F80
0x7FF640000000 1.7.3102
0x7FF650000000 1.7.3102
0x7FF6C0000000 1.7.2764
0x7FF6D0000000 1.7.2764
0x7FF760000000
0x7FF780000000
0x7FF7E0000000 1.7.3102
0x7FF7F0000000
0x7FF820000000*/
